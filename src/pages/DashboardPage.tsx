...
import { ShoppingCart, PiggyBank, Landmark, Loader2, AlertCircle, RefreshCw, Send, ArrowDownLeft, ArrowUpRight } from 'lucide-react';
...
const statIcons = [PiggyBank, ShoppingCart, Landmark];
